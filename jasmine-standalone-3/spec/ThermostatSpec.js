describe('Thermostat', function() {
  ...
  beforeEach(function() {
    ...
    it('can check it\'s current energy usage - low', function() {
      thermostat.decrease(3);
      expect(thermostat.energySetting()).toMatch("low-usage");
    });
    it('can check it\'s current energy usage - medium', function() {
      expect(thermostat.energySetting()).toMatch("medium-usage");
    });
    it('can check it\'s current energy usage - high', function() {
      thermostat.switchPowerMode();
      thermostat.increase(6);
      expect(thermostat.energySetting()).toMatch("high-usage");
    });
});
